        ...
        for i, (preds_for_problem, test_cases) in enumerate(zip(predictions, references)):
            ...
            for j, code in enumerate(preds_for_problem):
                ...
                if exec_result.success:
                    ...
                    # NOTE: do NOT increment `c` here — the correct-count was
                    # already incremented once above (`success and test_passed`).
                    # Counting it a second time inflated pass@k / avg@k ~2x.
                else:
