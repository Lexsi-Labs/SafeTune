"""
Colored logging and banner utilities for SafeTune.
...
SafeTune_BANNER = r"""
  ____        __  __      _   _       _    _ _             _____                  
 / ___|      |  \/  |    | | | |     / \  | (_) __ _ _ __ |_   _|   _ _ __   ___  
 \___ \      | |\/| |    | |_| |    / _ \ | | |/ _` | '_ \  | || | | | '_ \ / _ \ 
  ___) |     | |  | |    |  _  |   / ___ \| | | (_| | | | | | || |_| | | | |  __/ 
 |____/      |_|  |_|    |_| |_|  /_/   \_\_|_|\__, |_| |_| |_| \__,_|_| |_|\___| 
                                                |___/                              
"""

SafeTune_EVALUATION_BANNER = r"""
  ____        __  __      _   _       _    _ _             _____                       _____ __     __    _      _      
 / ___|      |  \/  |    | | | |     / \  | (_) __ _ _ __ |_   _|   _ _ __   ___       | ____|\ \   / /   / \    | |    
 \___ \      | |\/| |    | |_| |    / _ \ | | |/ _` | '_ \  | || | | | '_ \ / _ \      |  _|   \ \ / /   / _ \   | |    
  ___) |     | |  | |    |  _  |   / ___ \| | | (_| | | | | | || |_| | | | |  __/      | |___   \ V /   / ___ \  | |___ 
 |____/      |_|  |_|    |_| |_|  /_/   \_\_|_|\__, |_| |_| |_| \__,_|_| |_|\___|      |_____|   \_/   /_/   \_\ |_____|
                                                |___/                                                                     
"""


def print_SafeTune_banner(subtitle: Optional[str] = None):
    """Print the SafeTune ASCII art banner with optional subtitle."""
    print("\n" + "=" * 80)
    print(Fore.CYAN + SafeTune_BANNER + Fore.RESET)
    if subtitle:
...
def print_section_banner(title: str, char: str = "=", width: int = 80, color: str = Fore.CYAN, use_ascii: bool = False):
    ...
    if use_ascii and "EVALUATION" in title.upper():
        # Use ASCII art for SafeTune EVALUATION banner
        print("\n" + "=" * 80)
        print(Fore.CYAN + SafeTune_EVALUATION_BANNER + Fore.RESET)
        print("=" * 80 + "\n")
    else:
...
def setup_colored_logging(
    logger_name: str = "SafeTune",
    level: int = logging.INFO,
    format_string: Optional[str] = None
) -> logging.Logger:
    """
    Set up colored logging for SafeTune.
    
    Args:
        logger_name: Name of the logger (default: "SafeTune")
    ...
    if format_string is None:
        if COLORAMA_AVAILABLE:
            format_string = (
                f"{Fore.BLUE}[SafeTune]{Fore.RESET} "
            ...
            format_string = "[SafeTune] %(asctime)s %(levelname)s %(name)s:%(lineno)d - %(message)s"
...
def SafeTune_info(message: str, prefix: str = "[SafeTune]"):
    """Print an info message with SafeTune prefix."""
    print(f"{Fore.BLUE}{prefix}{Fore.RESET} {Fore.GREEN}INFO{Fore.RESET} - {message}")


def SafeTune_warning(message: str, prefix: str = "[SafeTune]"):
    """Print a warning message with SafeTune prefix."""
    print(f"{Fore.BLUE}{prefix}{Fore.RESET} {Fore.YELLOW}WARNING{Fore.RESET} - {message}")


def SafeTune_error(message: str, prefix: str = "[SafeTune]"):
    """Print an error message with SafeTune prefix."""
    print(f"{Fore.BLUE}{prefix}{Fore.RESET} {Fore.RED}ERROR{Fore.RESET} - {message}")


def SafeTune_success(message: str, prefix: str = "[SafeTune]"):
    """Print a success message with SafeTune prefix."""
    print(f"{Fore.BLUE}{prefix}{Fore.RESET} {Fore.GREEN}✓{Fore.RESET} {message}")


def SafeTune_step(step_num: int, total_steps: int, message: str, prefix: str = "[SafeTune]"):
...
def print_progress_bar(current: int, total: int, width: int = 50, prefix: str = "[SafeTune]"):
...
def init_SafeTune_logging(show_banner: bool = True, subtitle: Optional[str] = None):
    """
    Initialize SafeTune colored logging and optionally show banner.
    
    Args:
        show_banner: Whether to show the SafeTune banner
        subtitle: Optional subtitle to display below banner
    """
    if show_banner:
        print_SafeTune_banner(subtitle)
    
    # Set up colored logging
    logger = setup_colored_logging("SafeTune", logging.INFO)
