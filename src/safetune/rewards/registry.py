...
class RewardRegistry:
    ...
    def create_composite_reward(cls, reward_names: List[str], weights: Optional[List[float]] = None):
        ...
        # CompositeReward imported from .base at top level
...
def _initialize_default_rewards():
    ...
    # Safety reward; for hybrid safety with optional internal (e.g. circuit) signals, see SafeTune
    RewardRegistry.register_reward_type(
        "safety",
        RewardType.SAFETY,
    ...
    # NOTE: 'factuality' registration removed — no factory implementation maps
    # to RewardType.FACTUALITY; registering it made list_rewards() advertise an
    # uncreatable/mis-mapped reward.
    ...
    # NOTE: 'relevance' registration removed — no factory implementation maps
    # to RewardType.RELEVANCE; registering it made list_rewards() advertise an
    # uncreatable/mis-mapped reward.
