# Contributing to SafeTune

Thank you for your interest in contributing to SafeTune! We welcome contributions from the community.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/safetune.git
   cd safetune
   ```
3. **Add upstream remote**:
   ```bash
   git remote add upstream https://github.com/Lexsi-Labs/SafeTune.git
   ```
...
- Python 3.12 or higher (matches `pyproject.toml`)
- Git
- pip and setuptools
...
```bash
# Install in development mode with dev tooling
pip install -e ".[dev]"
```
...
3. **You grant** Lexsi Labs a perpetual, worldwide, royalty-free right to use,
   modify, distribute, and license your contributions under any terms,
   including commercial ones (LICENSE.md, Section 6).

This is required for contributions to be accepted into SafeTune.
...
Thank you for contributing to SafeTune! 🚀
